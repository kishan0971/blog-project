...
//        }
        teamRepository.findById(teamVisibility).orElseThrow(() -> new TeamNotFoundException("Invalid Team"));
    }
...
//        }
    	departmentRepository.findById(departmentVisibility).orElseThrow(() -> new DepartmentNotFoundException("Invalid Department"));
    }
